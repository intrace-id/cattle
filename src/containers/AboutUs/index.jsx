    ...
    return (
        <div className='d-flex flex-column align-items-center'>
            <div className='about-us-header d-flex flex-column align-items-center py-4'>
                <h1>Brings You to Next the Level <br/> Through Certification Training</h1>
                <div className='col-sm-10 col-md-8 mt-3'>
...
Construction, Manufacturing, etc.) need to upgrade their skills to stay competitive.</p>
            ...
            <div className='col-sm-12 col-md-10'>
                <div className='d-flex flex-column align-items-center py-4 mb-4'>
                    ...
                    <p className='col-md-6 col-sm-10 text-center'>We provide you with the curated (up-to-date) industry certification training program. We partnered with dozens of certification provider/institution/industry experts from overseas, and bring them closer to you. For companies, we provide in-house certification program for your employees to increase the engagement rate and your companies brand values.</p>
                    <a href={process.env.PUBLIC_URL + '/company_profile_intrace.pdf'} target='_blank' rel="noopener noreferrer">
                ...
                <div className='about-us-value d-flex flex-column align-items-center p-4'>
                    ...
                    <div className='d-flex mt-4 row'>
                        <div className="col-md-4 col-sm-12 d-flex flex-column align-items-center border-right">
                ...
                <div className='about-us-team d-flex flex-column align-items-center p-4'>
                    ...
                    <div className="row d-flex justify-content-center">
                        <div className="col-md-3 col-sm-12 row mt-3 d-flex justify-content-center">
                ...
                <div className='d-flex justify-content-between my-4 row'>
                    <div className="col-md-6 col-sm-12">
                        <h3 className="mt-3">Our Certification</h3>
                        <img className='mt-3' src={process.env.PUBLIC_URL + '/img/logo/iso-9001.jpg'} alt="ISO 9001"/>
                    </div>
                    <div className="col-md-6 col-sm-12">
                        <h3 className="mt-3">Partner & License</h3>
                        <div className="col-sm-12 d-flex row justify-content-center">
                            {
                                ['bnsp', 'drops', 'p2m',  'prakerja', 'bukalapak'].map( (partner) => 
                                <img 
                                    key={partner}
                                    className='my-2'
